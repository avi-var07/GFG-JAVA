...
class Solution{
    public static void main(String[] args) {
        ...
        ArrayList<String> list =  ratInMaze(arr);
    ...
    static void solve(int i, int j, ArrayList<String>ans, int visited[][], int maze[][], String path){
        ...
        for(int index=0;index<4;index++){
            ...
            if(nexti>=0&&nexti<maze.length&&nextj>=0&&nextj<maze.length&&visited[nexti][nextj]==0&&maze[nexti][nextj]==1)solve(nexti, nextj, ans, visited, maze, path+move.charAt(index));
        }
