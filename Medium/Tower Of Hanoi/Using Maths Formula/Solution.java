...
class Solution{
    public static void main(String[] args) {
        ...
        System.out.println("Enter Rod Number from: ");
        int from = sc.nextInt();
        System.out.println("Enter Rod Number To: ");
        int to = sc.nextInt();
        System.out.println("Enter Rod Number Aux: ");
        int aux = sc.nextInt();
        
        System.out.println("Number of steps is: "+towerOfHanoi(n, from, to, aux));
        sc.close();
    }
